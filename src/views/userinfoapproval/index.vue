    ...
    <div class="tanchuang">
      ...
      >
        <div class="zuo" style="width: 40%;float: left;">
          <div style="margin-bottom: 50px">单位名称 ： {{editDialog.models.unitname}}</div>
        ...
        <div class="you" style="width: calc(60% - 50px);float: left;margin-left: 50px">
          <div style="margin-bottom: 50px">身份证明号码 ： {{editDialog.models.idno}}</div>
          <div style="display: flex">
            该用户所属单位：
            <el-select v-model="editDialog.model.unitname" placeholder="请选择所属单位" @change="selectUnitName5" clearable >
          ...
          <div style="margin-bottom: 50px">更新时间 ： {{editDialog.models.updatetime}}</div>
<!--          <div style="margin-bottom: 50px">注册人 ： {{editDialog.models.adduserid}}</div>-->
          <div style="margin-bottom: 60px">备注 ： {{editDialog.models.note}}</div>
          ...
          .then(function(response) {
            if (response.data.code === 20000) {
              ...
              for (let i =0;i<response.data.data.length;i++){
                ...
                obj.unitid = response.data.data[i].id;
                that.util.push(obj)
              }
            }
          })
